...
d.css("backgroundColor",n);d.css("border",a.border);d.css("width",a.boxWidth);d.css("height",a.boxHeight);i.append(d);if(a.displayColorCode){d.text(this.value);d.css("color",a.colorCodeColor);d.css("textAlign",a.colorCodeAlign)}var k=c("<input type='button' value='"+a.buttonValue+"' class='simpleColorSelectButton "+a.buttonClass+"'>");i.append(k);var j=c("<input type='button' value='"+a.buttonCancelValue+"' class='simpleColorCancelButton "+a.buttonClass+"'>");i.append(j);j.hide();k.bind("click",{container:i,input:this,cancel_button:j,
