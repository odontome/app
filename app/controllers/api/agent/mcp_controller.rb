      ...
      def handle_initialize(id)
        render json: {
          ...
          result: {
            ...
            instructions: "This practice's timezone is #{@practice.timezone}. All times in tool responses are in this timezone. When the user says a time like '3pm', interpret it as #{@practice.timezone}. Always send times as ISO 8601 strings with the correct offset for this timezone."
          }
        }
      end
