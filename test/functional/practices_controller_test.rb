...
class PracticesControllerTest < ActionController::TestCase
  ...
  test 'agent settings links ChatGPT to the current plugin setup guide' do
    get :agent_settings

    assert_response :success
    assert_select "a[href='https://developers.openai.com/plugins/deploy/connect-chatgpt'][target='_blank'][rel='noopener']", text: 'ChatGPT'
