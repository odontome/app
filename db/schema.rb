...
ActiveRecord::Schema.define(version: 20_210_215_185_828) do
  ...
  create_table 'appointments', id: :serial, force: :cascade do |t|
    ...
    t.index %w[starts_at ends_at], name: 'index_appointments_on_starts_at_and_ends_at'
  end
  ...
  create_table 'notes', id: :serial, force: :cascade do |t|
    ...
    t.integer 'user_id'
    t.index %w[noteable_type noteable_id], name: 'index_notes_on_noteable_type_and_noteable_id'
  end
